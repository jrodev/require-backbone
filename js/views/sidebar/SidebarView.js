    ...
    'text!templates/sidebar/sidebarTemplate.html'
        ...
        var SidebarView = Backbone.View.extend({
            ...
            render: function(){
                ...
                var data = { ads: [backbone_ad, require_ad] };
                var compiledTemplate = _.template( sidebarTemplate, data );
                console.log("__this.$el:", this.$el, " - this.el:", this.el); 
                console.log('$(".sidebar"):', $(".sidebar"));
                console.log('__compiledTemplate->',compiledTemplate);
                this.$el.html(compiledTemplate); //$(".sidebar").append(compiledTemplate);
            }
